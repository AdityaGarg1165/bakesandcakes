...
export default function Login() {
    ...
    try{
      if(user[0].email){
        if(CryptoJS.AES.decrypt(user[0].password,'khotakhota').toString(CryptoJS.enc.Utf8) === password && user[0].email){
          ...
          localStorage.setItem('name',user[0].email)
  ...
  return (
      ...
      pauseOnHover
      />
      <div className="min-h -z-40 my-32 -full lb flex absolute items-center ml-smlogin md:ml-login justify-center py-12 px-4 sm:px-6 lg:px-8">
